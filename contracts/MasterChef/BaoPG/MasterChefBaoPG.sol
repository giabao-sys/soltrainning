...
contract MasterChefBaoPG is Ownable {
    ...
    IMigratorChefBaoPG public migrator;
    // Info of each pool.
    ...
    function setMigrator(IMigratorChefBaoPG _migrator) public onlyOwner {
        migrator = _migrator;
    }
